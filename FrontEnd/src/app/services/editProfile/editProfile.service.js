...
var EditProfileService = (function () {
    function EditProfileService(http) {
        this.http = http;
        this.url = backendUrl_service_1.BackendUrlService.url + '/profile/update';
        this.headers = new http_1.Headers({ 'Content-Type': 'application/json' });
    }
    EditProfileService.prototype.updateProfile = function () {
        return this.http
            .put(this.url, JSON.stringify({}), { headers: this.headers })
            .toPromise()
            .then(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    EditProfileService.prototype.handleError = function (error) {
